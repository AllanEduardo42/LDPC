...
function code_block_segmentation!(
    cw::Matrix{Int},
    b::Vector{Bool},
    C::Int,
    K_prime::Int,
...
function inv_code_concatenation(
    g::Vector{Bool},
    C::Int,
    E_r::Vector{Int}
)
