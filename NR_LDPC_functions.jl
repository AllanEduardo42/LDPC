...
function 
    code_block_segmentation(K,C,K_prime,L_2,b)
...
function 
    channel_coding(N,C,Zc,K_prime,K,bg,iLS,c)
    ...
    H, E_H = make_parity_check_matrix(bg,iLS,Zc)
...
function
    make_parity_check_matrix(bg,iLS,Zc)
