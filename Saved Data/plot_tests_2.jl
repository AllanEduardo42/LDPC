...
FB = ["F","B"]
markers = [:none, :none, :cross, :circle, :rect, :utriangle, :diamond]
modes = ["Flooding","LBP","SVNF","RBP", "List-RBP","NW-RBP","VN-RBP"]
...
for j=1:2
    ...
    for k in eachindex(modes)
        if modes[k] == "RBP" || modes[k] == "List-RBP" || modes[k] == "VN-RBP"
